...
function showUser(user) {
        ...
        xmlhttp.open("GET","history.php?user="+user,true);
        xmlhttp.send();
}
    
function interval(){ 
    setInterval(function(){ showUser(<?php echo $user;?>);}, 5000);
}
...
<div class="container">
    ...
    <h1>History of "My bids on the run...."</h1>
    <p class="lead">
        Click on a product to go to the page
    </p>
