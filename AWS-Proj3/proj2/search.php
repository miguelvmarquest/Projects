			...
			<div class="">
				<div class="row">
					 <div class="col-md-11">
                        ...
                        <div id='dia' >
                        <div style='margin-left:3.6%;' class="row col-md-9">
                        ...
                        <input style='margin-top:23px;margin-left:2%' name="send" class="btn btn-primary" type="submit" value='go'>
                        </div>
		...
		<?php
            ...
            if(isset($_POST["send"])){
                ...
                if (!count($productsarray)==0){
                    ...
                    while($row = mysqli_fetch_array($result, MYSQLI_NUM)){
    						if ($row[7] == NULL){
    						  echo "<div style='margin-left:8%;'  class='row col-md-9 list-group'><div class='col-xs-10 list-group-item'><a href='item.php?item_id=".$row[0]."'><div class='col-xs-12 col-xs-4'><img src='artigos/default.jpg' class='img-thumbnail' alt='".$row[1]."''></div><h4>".$row[1]."<span class='badge pull-right badge-default'>".$row[3]. " <span class='glyphicon glyphicon-bitcoin'></span></h4><p class='descript'><small class='description'>".$row[2]."</small></p></a></div></div>";
                            }
                            else{
                                
                                echo "<div style='margin-left:8%;' class='row col-md-9 list-group'><div class='col-xs-10 list-group-item'><a href='item.php?item_id=".$row[0]."'><div class='col-xs-12 col-xs-4'><img src='".$row[7]."' class='img-thumbnail' alt='".$row[1]."''></div><h4>".$row[1]."<span class='badge pull-right badge-default'>".$row[3]. " <span class='glyphicon glyphicon-bitcoin'></span></h4><p class='descript'><small class='description'>".$row[2]."</small></p></a></div></div>";
                            }
    				}
            ...
            }else if (!isset($s) || trim($s) == ''){
				    $query = "select id_product, name, description, valor, start_date, end_date, keywords,fotos from products order by start_date DESC limit 5";
    				$result = mysqli_query($conn, $query) or die("Error ". $query);
    				...
    				if ($num_rows == 0){
    					...
    					while($row = mysqli_fetch_array($result, MYSQLI_NUM)){
    						if ($row[7] == NULL){
    						  echo "<div style='margin-left:7.99%;'  class='row col-md-9 list-group'><div class='col-md-10 list-group-item'><a href='item.php?item_id=".$row[0]."'><div class='col-xs-12 col-xs-4'><img src='artigos/default.jpg' class='img-thumbnail' alt='".$row[1]."''></div><h4>".$row[1]."<span class='badge pull-right badge-default'>".$row[3]. " <span class='glyphicon glyphicon-bitcoin'></span></h4><p class='descript'><small class='description'>".$row[2]."</small></p></a></div></div>";
                            }
                            else{
                                
                                echo "<div style='margin-left:7.99%;' class='row col-md-9 list-group'><div class='col-xs-10 list-group-item'><a href='item.php?item_id=".$row[0]."'><div class='col-xs-12 col-xs-4'><img src='".$row[7]."' class='img-thumbnail' alt='".$row[1]."''></div><h4>".$row[1]."<span class='badge pull-right badge-default'>".$row[3]. " <span class='glyphicon glyphicon-bitcoin'></span></h4><p class='descript'><small class='description'>".$row[2]."</small></p></a></div></div>";
                            }
    					}
                    }
			}
                ...
                if (!count($productsarray)==0){
                    ...
                    while($row = mysqli_fetch_array($result, MYSQLI_NUM)){
    						if ($row[7] == NULL){
    						  echo "<div style='margin-left:142.5px;'  class='row col-md-9 list-group'><div class='col-md-10 list-group-item'><a href='item.php?item_id=".$row[0]."'><div class='col-xs-12 col-xs-4'><img src='artigos/default.jpg' class='img-thumbnail' alt='".$row[1]."''></div><h4>".$row[1]."<span class='badge pull-right badge-default'>".$row[3]. " <span class='glyphicon glyphicon-bitcoin'></span></h4><p class='descript'><small class='description'>".$row[2]."</small></p></a></div></div>";
                            }
                            else{
