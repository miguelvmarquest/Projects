...
def checkCommand(stri):
	...
	if lis[0].upper() == 'ADD':
		if len(lis)==3:
			try:
				r= requests.put('http://localhost:5000/alunos/inscricao/'+lis[1]+'/'+lis[2])
			...
			try:
				...
				r = requests.put('http://localhost:5000/alunos', json = dados)
			...
			try:
				...
				r = requests.put('http://localhost:5000/disciplinas', json = dados)
				if r.status_code == 201:
					print 'Status Code:',r.status_code, '(Created)'
				else:
					print 'Status Code:',r.status_code
			...
			try:
				...
				r = requests.put('http://localhost:5000/turmas', json = dados)
	...
	###############-----SHOW-------####################
		...
		if lis[1].upper() == 'ALL':
			...
			if lis[2].upper() == 'ALUNOS':
				if len(lis)==3:
					r = requests.get('http://localhost:5000/alunos/all') 
					...
					try:
						r = requests.get('http://localhost:5000/alunos/all/disciplina/%s' % lis[4])
					...
					try:
						r = requests.get('http://localhost:5000/alunos/all/turma/%s' % lis[4])
				...
				r = requests.get('http://localhost:5000/disciplinas/all') 
				cont = json.loads(r.content)
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				else:
				...
				if len(lis)==3:	
					r = requests.get('http://localhost:5000/turmas/all') 
					cont = json.loads(r.content)
					if r.status_code == 200:
						print 'Status Code:',r.status_code, '(Ok)'
					else:
					...
					try:
						tentar = int(lis[4])
						r = requests.get('http://localhost:5000/turmas/all/disciplina/%s' % lis[4]) 
			...
			try:
				r = requests.get('http://localhost:5000/alunos/%s' % lis[2]) 
				cont = json.loads(r.content)
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				else:
			...
			try:
				r = requests.get('http://localhost:5000/disciplinas/%s' % lis[2]) 
				cont = json.loads(r.content)
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				else:
			...
			try:
				r = requests.get('http://localhost:5000/turmas/%s' % lis[2]) 
				cont = json.loads(r.content)
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				else:
			...
			try:
				r = requests.get('http://localhost:5000/alunos/inscricao/'+lis[1]+'/'+lis[2]) 
				cont = json.loads(r.content)
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				else:
	...
	###############-----REMOVE-------####################
		...
		if lis[1].upper() == 'ALL':
			if lis[2].upper() == 'ALUNOS':
				if len(lis)==3:
					try:
						r = requests.delete('http://localhost:5000/alunos/all')
						if r.status_code == 200:
							print 'Status Code:',r.status_code, '(Ok)'
						elif r.status_code == 204:
							print 'Status Code:',r.status_code, '(No Content)'
					...
					try:
						r = requests.delete('http://localhost:5000/alunos/all/disciplina/'+lis[4])
						if r.status_code == 200:
							print 'Status Code:',r.status_code, '(Ok)'
						elif r.status_code == 204:
							print 'Status Code:',r.status_code, '(No Content)'
					...
					try:
						r = requests.delete('http://localhost:5000/alunos/all/turma/'+lis[4])
						if r.status_code == 200:
							print 'Status Code:',r.status_code, '(Ok)'
						elif r.status_code == 204:
							print 'Status Code:',r.status_code, '(No Content)'
				...
				try:
					r = requests.delete('http://localhost:5000/disciplinas/all')
					if r.status_code == 200:
						print 'Status Code:',r.status_code, '(Ok)'
					elif r.status_code == 204:
						print 'Status Code:',r.status_code, '(No Content)'
				...
				if len(lis)==3:
					try:
						r = requests.delete('http://localhost:5000/turmas/all')
						if r.status_code == 200:
							print 'Status Code:',r.status_code, '(Ok)'
						elif r.status_code == 204:
							print 'Status Code:',r.status_code, '(No Content)'
					...
					try:
						r = requests.delete('http://localhost:5000/turmas/all/disciplina/%s' % lis[4])
						if r.status_code == 200:
							print 'Status Code:',r.status_code, '(Ok)'
						elif r.status_code == 204:
							print 'Status Code:',r.status_code, '(No Content)'
			...
			try:
				r = requests.delete('http://localhost:5000/alunos/' + lis[2])
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				elif r.status_code == 204:
					print 'Status Code:',r.status_code, '(No Content)'
			...
			try:
				r = requests.delete('http://localhost:5000/disciplinas/' + lis[2])
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				elif r.status_code == 204:
					print 'Status Code:',r.status_code, '(No Content)'
			...
			try:
				r = requests.delete('http://localhost:5000/turmas/' + lis[2])
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				elif r.status_code == 204:
					print 'Status Code:',r.status_code, '(No Content)'
			...
			try:
				r = requests.delete('http://localhost:5000/alunos/inscricao/'+lis[1]+'/'+lis[2])
				if r.status_code == 200:
					print 'Status Code:',r.status_code, '(Ok)'
				elif r.status_code == 204:
					print 'Status Code:',r.status_code, '(No Content)'
